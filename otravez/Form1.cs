                ...
                else
                {
                    ...
                    using (var dbTransaction = db.Database.BeginTransaction())
                    {
                        try
                        {
                            ...
                            agentes.Add(new Model.AGENTS { AGENT_CODE = 4, AGENT_NAME = "Ramasundar", WORKING_AREA = "Bangalore", COMISSION = 0.15m, COUNTRY = "ny", PHONE_NO = "077-25714763" });
                            agentes.Add(new Model.AGENTS { AGENT_CODE = 3, AGENT_NAME = "Alex", WORKING_AREA = "London", COMISSION = 0.13m, COUNTRY = "nd", PHONE_NO = "075-12458969" });
                            agentes.Add(new Model.AGENTS { AGENT_CODE = 8, AGENT_NAME = "Alford", WORKING_AREA = "New york", COMISSION = 0.12m, COUNTRY = "nd", PHONE_NO = "044-25874365" });
                            agentes.Add(new Model.AGENTS { AGENT_CODE = 10, AGENT_NAME = "Santakumar", WORKING_AREA = "Chennai", COMISSION = 0.14m, COUNTRY = "nd", PHONE_NO = "007-22388644" });
                            agentes.Add(new Model.AGENTS { AGENT_CODE = 12, AGENT_NAME = "Lucida", WORKING_AREA = "San jose", COMISSION = 0.12m, COUNTRY = "nd", PHONE_NO = "044-52981425" });
                            agentes.Add(new Model.AGENTS { AGENT_CODE = 5, AGENT_NAME = "Anderson", WORKING_AREA = "Brisban", COMISSION = 0.13m, COUNTRY = "nd", PHONE_NO = "045-21447739" });
                            agentes.Add(new Model.AGENTS { AGENT_CODE = 4, AGENT_NAME = "Ivan", WORKING_AREA = "Torento", COMISSION = 0.15m, COUNTRY = "nd", PHONE_NO = "088-22544166" });
                            ...
                            clientes.Add(new Model.CUSTOMER { CUST_CODE = 13, CUST_NAME = "Holmes", WORKING_AREA = "London", CUST_COUNTRY = "UK", GRADE = 2, OPENING_AMT = 6000.00m, RECEIVE_AMT = 5000.00m, PAYMENT_AMT = 7000.00m, OUTSTANDING_AMT = 40000m, PHONE_NO = "BBBBBBB", AGENTS_CODE = 3 });
                            ...
                            ordenes.Add(new Model.ORDERS { ORD_NUM = 200103, ORD_AMOUNT = 1500.00m, ADVANCE_AMOUNT = 700.00m, ORD_DATE = new DateTime(2008, 05, 15), ORD_DESCRIPTION = "SOD", AGENT_CODE = 05, CUST_CODE = 1 });
                            ...
                            ordenes.Add(new Model.ORDERS { ORD_NUM = 200111, ORD_AMOUNT = 1000.00m, ADVANCE_AMOUNT = 300.00m, ORD_DATE = new DateTime(2008, 07, 10), ORD_DESCRIPTION = "SOD", AGENT_CODE = 08, CUST_CODE = 20 });
                            ordenes.Add(new Model.ORDERS { ORD_NUM = 200125, ORD_AMOUNT = 2000.00m, ADVANCE_AMOUNT = 600.00m, ORD_DATE = new DateTime(2008, 10, 10), ORD_DESCRIPTION = "SOD", AGENT_CODE = 005, CUST_CODE = 18 });
                            ...
                            MessageBox.Show("La base de datos ha sido poblada con exitaso mijo ", "operacione Exitosa", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
...

                        {
                            ...
                            MessageBox.Show("Che wacho hay un error nos jodimos.", "Error encontrado", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            Application.Exit();
                            return;
